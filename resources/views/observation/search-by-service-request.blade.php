...
@endif
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ route('observation.search-by-service-request') }}" method="GET">
                <div class="form-group">
                    <label for="encounter">Search by Service Request:</label>
                    <input type="text" class="form-control" id="encounter" name="encounter" placeholder="Enter observation encounter">
                </div>
                <div class="d-flex">
                    <div class="form-group">
                        <label for="based on">Based On Service Request:</label>
                        <input type="text" class="form-control" id="based on" name="based-on" placeholder="Enter observation based on">
                    </div>
                    <div class="form-group">
                        <label for="subject">Subject:</label>
                        <input type="text" class="form-control" id="subject" name="subject" placeholder="Enter observation subject">
                    </div>
                </div>
