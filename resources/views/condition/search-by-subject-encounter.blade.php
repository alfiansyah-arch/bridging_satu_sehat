...
<div class="container">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ route('condition.search-by-subject-encounter') }}" method="GET">
                ...
                <div class="d-flex">
                    ...
                    <div class="form-group mx-4">
                        ...
                        <input type="text" class="form-control" id="encounter" name="encounter" placeholder="Enter condition encounter">
                    </div>
                </div>
